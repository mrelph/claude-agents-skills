# Output Templates - Kraken-Branded Documents
...
- Game focus: 2-3 tactical bullet points for this game (e.g., "Heavy forecheck", "Roll four lines", "Compete every shift")
...
- Our response strategy: How our "Balanced Depth" identity counters this opponent
- Full lineup: Forward lines, defense pairs, goalies with ratings and roles
- Key matchups: Which lines to deploy against their top players
...
- Period-by-period approach: P1 (establish), P2 (maintain), P3 (take control with depth)
