...
def generate_executive_report(
    ...
    report.append("Confidence scores reflect source agreement, evidence quality, source authority, verification status, and recency.\n")

    report.append("### Confidence Scoring\n")
    report.append("Confidence levels reflect:")
    report.append("- Source agreement (35%)")
    report.append("- Evidence quality (25%)")
    report.append("- Source authority (20%)")
    report.append("- Verification status (10%)")
    ...
    report.append(f"*{datetime.now().strftime('%Y-%m-%d')} | v2.0.0*")
